...
data1 = np.load('X2.npz')
X1 = data1['x_train']
X2 = data1['x_test2']

y_1 = pd.read_csv('y_train.csv').to_numpy()
y_2 = pd.read_csv('y_test2.csv').to_numpy()
...
if __name__ == '__main__':
    ...
    for train, test in cv.split(y1):
        ...
        filepath = '1818/%sModel%d.tf' % (name, nn)
        ...
        model.save('1818/%sModel%d.h5' % (name, nn))
